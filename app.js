...
const extraCredit = Vue.component('extra-credit', {
  // props: ['points'],
  data: () => {
    return {
      score: 95,
  ...
  template: `
    <div class="extra-credit">
      ...
      <div id="controls">
          <button v-on:click="add">Give Extra Credit!</button>
          <button v-on:click="addMore">Give More Extra Credit!</button>
          <button v-on:click="bonus">MAGIC BUTTON</button>
      </div>
    </div>
  `,
});
